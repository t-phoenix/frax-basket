...
async function main() {
  ...
  // FRAX SWAP INBSTANCE
  const FraxSwapRouter = await hre.ethers.getContractAt(FraxSwapRouterABI, '0x39cd4db6460d8B5961F73E997E86DdbB7Ca4D5F6')
  const initcode = await FraxSwapRouter.INIT_CODE_HASH();

  console.log("Checking init code: ", initcode)


  // Checking read functions
  ...
  // Selling wfrxETH to FRAX
  const amountIN = await FraxSwapRouter.getAmountsIn(3302989575437525555n, [wfrxETH.target, FRAX.target]);
  console.log("wfrxETH needed for 3.3 FRAX output: ",amountIN)
